...
// NOTE: This is a modified version of the command-palette-view.js.
// Modified parts are marked with 'atom-taito-cli'. Original:
...
export default class AtomTaitoCliView {
  ...
  async show (showHiddenCommands = false) {
    ...
    const commands = await asyncExec('taito -d --print-commands');
